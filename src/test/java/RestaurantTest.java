...
class RestaurantTest {
   ...
   /* @Test
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        restaurant.addToMenu("Sweet corn soup",119);
        restaurant.addToMenu("Vegetable lasagne", 269);
        LocalTime mockedTime = LocalTime.parse("20:00:00");
        Restaurant spiedRest= Mockito.spy(restaurant);
        Mockito.lenient().when(spiedRest.getCurrentTime()).thenReturn(mockedTime);
        assertEquals(true, spiedRest.isRestaurantOpen());
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        Restaurant spiedRest= Mockito.spy(restaurant);
        Mockito.lenient().when(spiedRest.getCurrentTime()).thenReturn(mockedTime);
       assertEquals(false, spiedRest.isRestaurantOpen());
